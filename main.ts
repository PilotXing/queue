...
class PracticeView extends ItemView {
    ...
    async render() {
        ...
        // Also apply directly to container to ensure full coverage
...
class QueueControlView extends ItemView {
    ...
    async render() {
        ...
        // Compact filters (category + familiarity)
        ...
        // Compact settings (insert position + font size)
    ...
    private renderThemeGrid(parent: HTMLElement) {
        ...
        THEMES.forEach(theme => {
            ...
            // Check if this theme matches current settings
            const matches = this.plugin.settings.textColor === theme.text && this.plugin.settings.bgColor === theme.bg;
            // Special case for Default theme with CSS variables
